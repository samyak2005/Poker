    ...
    return (
        ...
        {gameEnd && (
            <div className="fixed inset-0 flex items-center justify-center z-50">
                <div className="bg-pink-900/95 rounded-lg p-8 max-w-md mx-4">
        ...
        <div className="pink-gameroom-bg h-screen">
            ...
            <div className="flex justify-center items-center">
                ...
                <Timer timer={timer} setTimer={setTimer} folded={folded} setFolded={setFolded} turn={isMyTurn} setTurn={setTurn} color={`bg-gradient-to-r from-[#831843] via-[#be185d] to-[#ec4899]`} />
            </div>
        </div>
        </>
    );
...
export default MultiplayerPinkGameRoom; 